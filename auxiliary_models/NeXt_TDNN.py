...
from auxiliary_models.utils import LayerNorm
...
class NeXtTDNN(nn.Module): #
    ...
    def __init__(self, in_chans=80, # in_channels: 3 -> 80
        ...
        block = importlib.import_module(f"auxiliary_models.{block}").__getattribute__(block) # TSConvNeXt_light or TSConvNeXt
